...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.32\textwidth}>{\raggedright\arraybackslash}p{0.17\textwidth}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
\toprule
...
Keep \texttt{data/processed/week03\_v1/} as the canonical Processed V1 output folder. Make sure the report links and filenames match the actual artifacts:
...
Keep the run commands documented in \texttt{README.md} so the workflow stays reproducible.
